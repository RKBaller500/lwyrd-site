  ...
  return (
    <div className="bg-[#FFFFFF] border border-[#E7E7E3] rounded-3xl overflow-hidden">
      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          {filtered.map((cat, i) => (
            <tr key={cat.slug} className={`border-b border-[#E7E7E3] last:border-0 ${i % 2 === 0 ? "" : "bg-white/40"}`}>
              ...
              <td className="px-5 py-3.5">
                <div className="flex items-center gap-3 justify-end">
                  <Link href={`/admin/categories/${cat.slug}`} className="text-xs text-[#002B55] hover:opacity-70 transition-opacity font-medium">Edit</Link>
